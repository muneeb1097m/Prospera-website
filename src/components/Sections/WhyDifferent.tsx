...
import { WhyDifferentContent } from "@/lib/content/defaults";

const defaultImages = [
    "/tailored-small-business01.png",
    "/Whywe're different001.png",
    "/Whywe'redifferent002.png",
    "/Whywe'redifferent003.png",
    "/tailored-service-based01.png",
];
...
interface WhyDifferentProps {
    content?: WhyDifferentContent;
}

export default function WhyDifferent({ content }: WhyDifferentProps) {
    const heading = content?.heading || "Why Prospera Is Different";
            ...
            <div className="container mx-auto px-6 lg:px-12 max-w-[1400px]">
                ...
                <div className="flex flex-wrap justify-center gap-6 lg:gap-8">
                    {items.map((item, index) => {
                        const imageSrc = defaultImages[index % defaultImages.length];
                        return (
                            <motion.div
                                key={index}
